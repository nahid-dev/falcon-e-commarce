  ...
  return (
    <Card className="mt-4 lg:mt-0">
      ...
      <CardContent className="space-y-3 sm:space-y-4 pt-0">
        ...
        <p className="text-xs sm:text-sm text-gray-600">Delivery within 2-3 days</p>
        
        <div className="text-xs sm:text-sm text-red-600">Express - Not Available</div>
        ...
        <div className="border-t pt-3 sm:pt-4">
          ...
          <div className="flex items-start space-x-2 sm:space-x-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="text-sm font-medium">HD FASHION HOUSE</div>
